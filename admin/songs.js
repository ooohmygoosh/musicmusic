      ...
      <div class="library-main">
        ...
        <div class="row library-head">
          <div>
            ...
            <div class="muted library-owner">${creatorLabel} · ${sourceLabel} · ${visibilityLabel} · ${publishLabel} · ${revenueLabel}</div>
            <div class="muted library-owner">Owner: ${ownerLabel}${item.official_fallback ? " · Official fallback" : ""}</div>
          </div>
